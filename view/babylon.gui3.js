...
var ImageScrollBar = /** @class */ (function (_super) {
    ...
    ImageScrollBar.prototype._draw = function (context) {
        ...
        if (this._backgroundImage) {
            this._tempMeasure.copyFromFloats(left, top, width, height);
            if (this.isVertical) {
                this._tempMeasure.copyFromFloats(left, this._currentMeasure.top + this._effectiveThumbThickness, this._currentMeasure.height, this._currentMeasure.width * this._barImageHeight);
                this._backgroundImage._currentMeasure.copyFrom(this._tempMeasure);
                context.save();
                this._backgroundImage._rotation = -Math.PI / 2;
                this._backgroundImage._transform(context);
                this._backgroundImage._draw(context);
                context.restore();
            }
            else {
